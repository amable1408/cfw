...
**60 modules** (245 files) at HEAD; the last tagged release is **0.2.0**. A
...
| `crypto/hash` | 1 .c / 1 .h | tests/crypto/hash/ |  |
| `crypto/hmac` | 1 .c / 1 .h | tests/crypto/hmac/ |  |
| `crypto/kdf` | 1 .c / 1 .h | tests/crypto/kdf/ |  |
| `crypto/password` | 1 .c / 1 .h | tests/crypto/password/ |  |
...
| `encoding/quoted_printable` | 1 .c / 1 .h | tests/encoding/quoted_printable/ |  |
...
| `http/server` | 1 .c / 1 .h | tests/http/server/ |  |
...
| `http/service/csrf` | 1 .c / 1 .h | tests/http/service/csrf/ | HTTP CSRF service for the C Libraries Framework |
...
| `http/service/rate_limit` | 1 .c / 1 .h | tests/http/service/rate_limit/ | HTTP rate limiting service for the C Libraries Framework |
| `http/service/security` | 1 .c / 1 .h | tests/http/service/security/ | HTTP security headers service for the C Libraries Framework |
| `http/service/session` | 1 .c / 1 .h | tests/http/service/session/ | HTTP session service for the C Libraries Framework |
| `http/service/static` | 1 .c / 1 .h | tests/http/service/static/ | HTTP static file service for the C Libraries Framework |
| `http/service/trace` | 1 .c / 1 .h | tests/http/service/trace/ | HTTP request/response access trace service for the C Libraries Framework |
| `http/service/traceparent` | 1 .c / 1 .h | tests/http/service/traceparent/ | HTTP traceparent service for the C Libraries Framework |
...
| `net` | 1 .c / 1 .h | tests/net/ | Cross-platform BSD-socket abstraction for the C Libraries Framework |
