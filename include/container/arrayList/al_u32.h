/*
 * al_u32.h - Dynamic array list of U32 for the C Libraries Framework
 *
 * Features:
 *   - Dynamic, growable array of U32 values
 *   - Arena or heap allocation support
 *   - Add, remove, access, and manage U32 elements efficiently
 *
 * Family:
 ...
 * Usage Examples:
 *   @code
 *   AL_U32 list = al_u32_init_1();
 *   al_u32_add_last(&list, 3);
 *   U32 *val = al_u32_at(&list, 0);
 *   al_u32_uninit(&list);
 *   @endcode
 *
 * Error Handling:
 ...
 *     free. al_u32_uninit releases the buffer. Arena-backed lists are freed by releasing the arena.
 *
 ...
 *
 * See al_u32.c for implementation details.
 */

#ifndef CONTAINER_ARRAYLIST_U32_H
#define CONTAINER_ARRAYLIST_U32_H

#include <allocator/allocator.h>

/**
 * @brief Dynamic array list of U32 values.
 */
typedef struct {
 ...
 * @param data Array of U32 values.
...
/**
 * @brief Allocate a new AL_U32 on the arena.
 * @param allocator Arena pointer.
 * @return Pointer to new AL_U32.
 */
AL_U32* al_u32_alloc_new_1(Arena *allocator);

/**
 * @brief Allocate a new AL_U32 with capacity on the arena.
 * @param capacity Initial capacity.
 * @param allocator Arena pointer.
 * @return Pointer to new AL_U32.
 * @note capacity and data_size are CALLER contracts: zero, or a value large
...
/**
 * @brief Allocate a new AL_U32 from data and size on the arena.
 * @param data Array of U32 values.
 * @param data_size Number of elements.
 * @param allocator Arena pointer.
 * @return Pointer to new AL_U32.
 ...
 * @param self Address of AL_U32 pointer.
 */
...
/**
 * @brief Allocate a new AL_U32 on the heap.
 * @return Pointer to new AL_U32.
 */
AL_U32* al_u32_new_1(void);

/**
 * @brief Allocate a new AL_U32 with capacity on the heap.
 * @param capacity Initial capacity.
 * @return Pointer to new AL_U32.
 * @note capacity and data_size are CALLER contracts: zero, or a value large
 *         enough to wrap the byte size, is checked as a programming error. Never
...
/**
 * @brief Allocate a new AL_U32 from data and size on the heap.
 * @param data Array of U32 values.
 * @param data_size Number of elements.
 * @return Pointer to new AL_U32.
 * @note capacity and data_size are CALLER contracts: zero, or a value large
...
#endif // CONTAINER_ARRAYLIST_U32_H