#include <container/arrayList/al_u32.h>

#define _AL_U32_GROWTH_FACTOR 2
...
static AL_U32 _al_u32_init(Arena *allocator)
#else
static AL_U32 _al_u32_init(void)
#endif // ARENA_IMPLEMENTATION
{
    AL_U32 al_u32 = DEFAULT_INITIALIZATION;

#ifdef ARENA_IMPLEMENTATION
    if (!memory_empty((void*) allocator)) {
        al_u32.allocator = allocator;
    }
#endif // ARENA_IMPLEMENTATION
...
#ifdef ARENA_IMPLEMENTATION
AL_U32 al_u32_alloc_init_1(Arena *allocator) {
    trace_log_push(LOG_METADATA);

    error_check_null(LOG_METADATA, "allocator", (void*) allocator);

    AL_U32 al_u32 = _al_u32_init(allocator);
...
AL_U32 al_u32_alloc_init_2(USize const capacity, Arena *allocator) {
    trace_log_push(LOG_METADATA);

    error_check_non_value_uint(LOG_METADATA, "capacity", capacity);

    AL_U32 al_u32 = al_u32_alloc_init_1(allocator);

    al_u32.capacity = capacity;
    ...
    if (al_u32.capacity > USIZE_MAX / sizeof(U32)) {
        al_u32.capacity = 0;
    ...
    al_u32.data = (U32*) allocator_borrow(sizeof(U32) * al_u32.capacity, allocator);
    ...
    if (memory_empty((void*) al_u32.data)) {
        al_u32.capacity = 0;
    }
...
AL_U32 al_u32_alloc_init_3(U32 const *const data, USize const data_size, Arena *allocator) {
    trace_log_push(LOG_METADATA);

    error_check_null(LOG_METADATA, "data", (void*) data);
    error_check_non_value_uint(LOG_METADATA, "data_size", data_size);

    AL_U32 al_u32 = al_u32_alloc_init_2(data_size, allocator);
    ...
    for (USize i = 0; i < al_u32.capacity && i < data_size; i += 1) {
        al_u32.data[i] = data[i];
...
AL_U32* al_u32_alloc_new_1(Arena *allocator) {
    trace_log_push(LOG_METADATA);

    error_check_null(LOG_METADATA, "allocator", (void*) allocator);

    AL_U32 *const al_u32 = (AL_U32*) allocator_borrow(sizeof(AL_U32), allocator);
    ...
    if (memory_empty((void*) al_u32)) {
        trace_log_pop();

        return nullptr;
    }

    *al_u32 = al_u32_alloc_init_1(allocator);
...
AL_U32* al_u32_alloc_new_2(USize const capacity, Arena *allocator) {
    trace_log_push(LOG_METADATA);

    error_check_non_value_uint(LOG_METADATA, "capacity", capacity);

    AL_U32 *const al_u32 = al_u32_alloc_new_1(allocator);
    ...
    *al_u32 = al_u32_alloc_init_2(capacity, allocator);
...
AL_U32* al_u32_alloc_new_3(U32 const *const data, USize const data_size, Arena *allocator) {
    trace_log_push(LOG_METADATA);
    ...
    *al_u32 = al_u32_alloc_init_3(data, data_size, allocator);
...
void al_u32_add(AL_U32 *const self, U32 const data, USize const index) {
    trace_log_push(LOG_METADATA);
    ...
    if (self->size == self->capacity) {
        if (self->capacity == 0) {
            al_u32_reserve(self, _AL_U32_GROWTH_FACTOR);
        }
        else {
            al_u32_reserve(self, self->capacity > USIZE_MAX / _AL_U32_GROWTH_FACTOR ? USIZE_MAX : self->capacity * _AL_U32_GROWTH_FACTOR);
        }
    }
...
void al_u32_add_first(AL_U32 *const self, U32 const data) {
    trace_log_push(LOG_METADATA);

    al_u32_add(self, data, 0);

    trace_log_pop();
}

void al_u32_add_last(AL_U32 *const self, U32 const data) {
    trace_log_push(LOG_METADATA);

    error_check_null(LOG_METADATA, "self", (void*) self);

    al_u32_add(self, data, self->size);

    trace_log_pop();
}

U32* al_u32_at(AL_U32 const *const self, USize const index) {
    trace_log_push(LOG_METADATA);
    ...
    return (U32*) &(self->data[index]);
}

U32* al_u32_back(AL_U32 const *const self) {
    trace_log_push(LOG_METADATA);
    ...
    return (U32*) &(self->data[self->size - 1]);
}

void al_u32_clear(AL_U32 *const self) {
    trace_log_push(LOG_METADATA);
...
void al_u32_delete(AL_U32 **const self) {
    trace_log_push(LOG_METADATA);
...
bool al_u32_empty(AL_U32 const *const self) {
    trace_log_push(LOG_METADATA);
...
U32* al_u32_front(AL_U32 const *const self) {
    trace_log_push(LOG_METADATA);
    ...
    return (U32*) &(self->data[0]);
}

USize al_u32_get_capacity(AL_U32 const *const self) {
    trace_log_push(LOG_METADATA);
...
U32* al_u32_get_data(AL_U32 const *const self) {
    trace_log_push(LOG_METADATA);
...
USize al_u32_get_size(AL_U32 const *const self) {
    trace_log_push(LOG_METADATA);
...
AL_U32 al_u32_init_1(void) {
#ifdef ARENA_IMPLEMENTATION
    return _al_u32_init(nullptr);
#else
    return _al_u32_init();
#endif // ARENA_IMPLEMENTATION
}

AL_U32 al_u32_init_2(USize const capacity) {
    trace_log_push(LOG_METADATA);

    error_check_non_value_uint(LOG_METADATA, "capacity", capacity);

    AL_U32 al_u32 = al_u32_init_1();
...
#ifdef ARENA_IMPLEMENTATION
    al_u32.data = (U32*) allocator_borrow(sizeof(U32) * al_u32.capacity, nullptr);
#else
    al_u32.data = (U32*) allocator_borrow(sizeof(U32) * al_u32.capacity);
#endif // ARENA_IMPLEMENTATION
...
AL_U32 al_u32_init_3(U32 const *const data, USize const data_size) {
    trace_log_push(LOG_METADATA);

    error_check_null(LOG_METADATA, "data", (void*) data);
    error_check_non_value_uint(LOG_METADATA, "data_size", data_size);

    AL_U32 al_u32 = al_u32_init_2(data_size);
...
AL_U32* al_u32_new_1(void) {
    trace_log_push(LOG_METADATA);

#ifdef ARENA_IMPLEMENTATION
    AL_U32 *const al_u32 = (AL_U32*) allocator_borrow(sizeof(AL_U32), nullptr);
#else
    AL_U32 *const al_u32 = (AL_U32*) allocator_borrow(sizeof(AL_U32));
#endif // ARENA_IMPLEMENTATION

    *al_u32 = al_u32_init_1();
...
AL_U32* al_u32_new_2(USize const capacity) {
    trace_log_push(LOG_METADATA);

    error_check_non_value_uint(LOG_METADATA, "capacity", capacity);

    AL_U32 *const al_u32 = al_u32_new_1();

    *al_u32 = al_u32_init_2(capacity);
...
AL_U32* al_u32_new_3(U32 const *const data, USize const data_size) {
    trace_log_push(LOG_METADATA);
    ...
    *al_u32 = al_u32_init_3(data, data_size);
...
void al_u32_remove(AL_U32 *const self, USize const index) {
    trace_log_push(LOG_METADATA);
...
void al_u32_remove_first(AL_U32 *const self) {
    trace_log_push(LOG_METADATA);
    ...
    al_u32_remove(self, 0);

    trace_log_pop();
}

void al_u32_remove_last(AL_U32 *const self) {
    trace_log_push(LOG_METADATA);
    ...
    al_u32_remove(self, self->size - 1);

    trace_log_pop();
}

void al_u32_reserve(AL_U32 *const self, USize const capacity) {
    trace_log_push(LOG_METADATA);
    ...
    if (capacity > self->capacity) {
        ...
        if (self->capacity > USIZE_MAX / sizeof(U32)) {
...
#ifdef ARENA_IMPLEMENTATION
        self->data = (U32*) allocator_borrow(sizeof(U32) * self->capacity, self->allocator);
#else
        self->data = (U32*) allocator_borrow(sizeof(U32) * self->capacity);
#endif // ARENA_IMPLEMENTATION
...
void al_u32_shrink(AL_U32 *const self) {
    trace_log_push(LOG_METADATA);
...
void al_u32_uninit(AL_U32 *const self) {
    trace_log_push(LOG_METADATA);
