...
#define _AL_F32_GROWTH_FACTOR 2
...
static AL_F32 _al_f32_init(Arena *allocator)
#else
static AL_F32 _al_f32_init(void)
#endif // ARENA_IMPLEMENTATION
{
    AL_F32 al_f32 = DEFAULT_INITIALIZATION;

#ifdef ARENA_IMPLEMENTATION
    if (!memory_empty((void*) allocator)) {
        al_f32.allocator = allocator;
    }
#endif // ARENA_IMPLEMENTATION
...
AL_F32 al_f32_alloc_init_1(Arena *allocator) {
    ...
    AL_F32 al_f32 = _al_f32_init(allocator);
...
AL_F32 al_f32_alloc_init_2(USize const capacity, Arena *allocator) {
    ...
    AL_F32 al_f32 = al_f32_alloc_init_1(allocator);

    al_f32.capacity = capacity;
    ...
    if (al_f32.capacity > USIZE_MAX / sizeof(F32)) {
        al_f32.capacity = 0;
    ...
    al_f32.data = (F32*) allocator_borrow(sizeof(F32) * al_f32.capacity, allocator);
    ...
    if (memory_empty((void*) al_f32.data)) {
        al_f32.capacity = 0;
    }
...
AL_F32 al_f32_alloc_init_3(F32 const *const data, USize const data_size, Arena *allocator) {
    ...
    AL_F32 al_f32 = al_f32_alloc_init_2(data_size, allocator);
    ...
    for (USize i = 0; i < al_f32.capacity && i < data_size; i += 1) {
        al_f32.data[i] = data[i];
...
AL_F32* al_f32_alloc_new_1(Arena *allocator) {
    ...
    AL_F32 *const al_f32 = (AL_F32*) allocator_borrow(sizeof(AL_F32), allocator);
    ...
    if (memory_empty((void*) al_f32)) {
        trace_log_pop();

        return nullptr;
    }

    *al_f32 = al_f32_alloc_init_1(allocator);
...
AL_F32* al_f32_alloc_new_2(USize const capacity, Arena *allocator) {
    ...
    AL_F32 *const al_f32 = al_f32_alloc_new_1(allocator);
    ...
    *al_f32 = al_f32_alloc_init_2(capacity, allocator);
...
AL_F32* al_f32_alloc_new_3(F32 const *const data, USize const data_size, Arena *allocator) {
    ...
    *al_f32 = al_f32_alloc_init_3(data, data_size, allocator);
...
void al_f32_add(AL_F32 *const self, F32 const data, USize const index) {
    ...
    if (self->size == self->capacity) {
        if (self->capacity == 0) {
            al_f32_reserve(self, _AL_F32_GROWTH_FACTOR);
        }
        else {
            al_f32_reserve(self, self->capacity > USIZE_MAX / _AL_F32_GROWTH_FACTOR ? USIZE_MAX : self->capacity * _AL_F32_GROWTH_FACTOR);
        }
    }
...
void al_f32_add_last(AL_F32 *const self, F32 const data) {
    ...
    al_f32_add(self, data, self->size);
...
F32* al_f32_back(AL_F32 const *const self) {
    ...
    return (F32*) &(self->data[self->size - 1]);
}
...
#ifdef ARENA_IMPLEMENTATION
    al_f32.data = (F32*) allocator_borrow(sizeof(F32) * al_f32.capacity, nullptr);
#else
    al_f32.data = (F32*) allocator_borrow(sizeof(F32) * al_f32.capacity);
#endif // ARENA_IMPLEMENTATION
...
AL_F32 al_f32_init_3(F32 const *const data, USize const data_size) {
    ...
    AL_F32 al_f32 = al_f32_init_2(data_size);
...
#ifdef ARENA_IMPLEMENTATION
    AL_F32 *const al_f32 = (AL_F32*) allocator_borrow(sizeof(AL_F32), nullptr);
#else
    AL_F32 *const al_f32 = (AL_F32*) allocator_borrow(sizeof(AL_F32));
#endif // ARENA_IMPLEMENTATION

    *al_f32 = al_f32_init_1();
...
AL_F32* al_f32_new_2(USize const capacity) {
    ...
    AL_F32 *const al_f32 = al_f32_new_1();

    *al_f32 = al_f32_init_2(capacity);
...
AL_F32* al_f32_new_3(F32 const *const data, USize const data_size) {
    ...
    *al_f32 = al_f32_init_3(data, data_size);
...
void al_f32_remove_last(AL_F32 *const self) {
    ...
    al_f32_remove(self, self->size - 1);
...
void al_f32_reserve(AL_F32 *const self, USize const capacity) {
    ...
    if (capacity > self->capacity) {
        ...
        if (self->capacity > USIZE_MAX / sizeof(F32)) {
...
#ifdef ARENA_IMPLEMENTATION
        self->data = (F32*) allocator_borrow(sizeof(F32) * self->capacity, self->allocator);
#else
        self->data = (F32*) allocator_borrow(sizeof(F32) * self->capacity);
#endif // ARENA_IMPLEMENTATION
