#include <container/arrayList/al_i64.h>

#define _AL_I64_GROWTH_FACTOR 2
...
static AL_I64 _al_i64_init(Arena *allocator)
#else
static AL_I64 _al_i64_init(void)
#endif // ARENA_IMPLEMENTATION
{
    AL_I64 al_i64 = DEFAULT_INITIALIZATION;

#ifdef ARENA_IMPLEMENTATION
    if (!memory_empty((void*) allocator)) {
        al_i64.allocator = allocator;
    }
#endif // ARENA_IMPLEMENTATION
...
AL_I64 al_i64_alloc_init_1(Arena *allocator) {
    ...
    AL_I64 al_i64 = _al_i64_init(allocator);
...
AL_I64 al_i64_alloc_init_2(USize const capacity, Arena *allocator) {
    ...
    AL_I64 al_i64 = al_i64_alloc_init_1(allocator);

    al_i64.capacity = capacity;
    ...
    if (al_i64.capacity > USIZE_MAX / sizeof(I64)) {
        al_i64.capacity = 0;
    ...
    al_i64.data = (I64*) allocator_borrow(sizeof(I64) * al_i64.capacity, allocator);
    ...
    if (memory_empty((void*) al_i64.data)) {
        al_i64.capacity = 0;
    }
...
AL_I64 al_i64_alloc_init_3(I64 const *const data, USize const data_size, Arena *allocator) {
    ...
    AL_I64 al_i64 = al_i64_alloc_init_2(data_size, allocator);
    ...
    for (USize i = 0; i < al_i64.capacity && i < data_size; i += 1) {
        al_i64.data[i] = data[i];
...
AL_I64* al_i64_alloc_new_1(Arena *allocator) {
    ...
    AL_I64 *const al_i64 = (AL_I64*) allocator_borrow(sizeof(AL_I64), allocator);
    ...
    if (memory_empty((void*) al_i64)) {
        trace_log_pop();

        return nullptr;
    }

    *al_i64 = al_i64_alloc_init_1(allocator);
...
AL_I64* al_i64_alloc_new_2(USize const capacity, Arena *allocator) {
    ...
    AL_I64 *const al_i64 = al_i64_alloc_new_1(allocator);
    ...
    *al_i64 = al_i64_alloc_init_2(capacity, allocator);
...
AL_I64* al_i64_alloc_new_3(I64 const *const data, USize const data_size, Arena *allocator) {
    ...
    *al_i64 = al_i64_alloc_init_3(data, data_size, allocator);
...
void al_i64_add(AL_I64 *const self, I64 const data, USize const index) {
    ...
    if (self->size == self->capacity) {
        if (self->capacity == 0) {
            al_i64_reserve(self, _AL_I64_GROWTH_FACTOR);
        }
        else {
            al_i64_reserve(self, self->capacity > USIZE_MAX / _AL_I64_GROWTH_FACTOR ? USIZE_MAX : self->capacity * _AL_I64_GROWTH_FACTOR);
        }
    }
...
void al_i64_add_last(AL_I64 *const self, I64 const data) {
    ...
    al_i64_add(self, data, self->size);
...
I64* al_i64_back(AL_I64 const *const self) {
    ...
    return (I64*) &(self->data[self->size - 1]);
}
...
#ifdef ARENA_IMPLEMENTATION
    al_i64.data = (I64*) allocator_borrow(sizeof(I64) * al_i64.capacity, nullptr);
#else
    al_i64.data = (I64*) allocator_borrow(sizeof(I64) * al_i64.capacity);
#endif // ARENA_IMPLEMENTATION
...
AL_I64 al_i64_init_3(I64 const *const data, USize const data_size) {
    ...
    AL_I64 al_i64 = al_i64_init_2(data_size);
...
#ifdef ARENA_IMPLEMENTATION
    AL_I64 *const al_i64 = (AL_I64*) allocator_borrow(sizeof(AL_I64), nullptr);
#else
    AL_I64 *const al_i64 = (AL_I64*) allocator_borrow(sizeof(AL_I64));
#endif // ARENA_IMPLEMENTATION

    *al_i64 = al_i64_init_1();
...
AL_I64* al_i64_new_2(USize const capacity) {
    ...
    AL_I64 *const al_i64 = al_i64_new_1();

    *al_i64 = al_i64_init_2(capacity);
...
AL_I64* al_i64_new_3(I64 const *const data, USize const data_size) {
    ...
    *al_i64 = al_i64_init_3(data, data_size);
...
void al_i64_remove_last(AL_I64 *const self) {
    ...
    al_i64_remove(self, self->size - 1);
...
void al_i64_reserve(AL_I64 *const self, USize const capacity) {
    ...
    if (capacity > self->capacity) {
        ...
        if (self->capacity > USIZE_MAX / sizeof(I64)) {
...
#ifdef ARENA_IMPLEMENTATION
        self->data = (I64*) allocator_borrow(sizeof(I64) * self->capacity, self->allocator);
#else
        self->data = (I64*) allocator_borrow(sizeof(I64) * self->capacity);
#endif // ARENA_IMPLEMENTATION
